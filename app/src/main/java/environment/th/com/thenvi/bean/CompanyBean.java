...
public class CompanyBean implements Serializable{
    ...
    private String OFFICEPHON=""; //
    private String EMAIL=""; //
    private String UNITTYPENA=""; //
    private String ISMONITOR=""; //
    private String INDUSTRYTY=""; //
    private String ENVIRONM_1=""; //
    private String X=""; //
    private String Y=""; //
    ...
    private String CORPORAT_1=""; //
    private String PSCLASSNAM=""; //
    private String RUNDATE=""; //
    private String REGIONNAME=""; //
    private String PSWEBSITE=""; //
    private String MOBILEPHON=""; //
    private String PSSCALENAM=""; //
    private String PSADDRESS=""; //
    private String DISPOSETYP=""; //
    private String PSNAME=""; //
    private String IFTHIRTYTE=""; //
    private String COMMUNICAT=""; //
    private String OPENACOCUN=""; //
    private String BANKACCOUN=""; //
    private String AREANAME=""; //
    private String CORPORATIO=""; //
    private String FAX=""; //
